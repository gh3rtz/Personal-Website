...
const CTA = () => {
  ...
  return (
    <section
      id="hobbies"
      className="dark:text-white bg-gray-900 dark:bg-gray-900"
    >
      <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6 bg-gray-900 rounded-xl">
